function sbcRip(d: any) {
    ...
    var l: any = d.length, RGB: any = new Object();
    if (l > 9) {
        d = d.split(",");
...
function shadeBlendConvert(p: any, from: any, to: any = null) {
    if (typeof (p) != "number" || p < -1 || p > 1 || typeof (from) != "string" || (from[0] != 'r' && from[0] != '#') || (typeof (to) != "string" && typeof (to) != "undefined")) return null; //ErrorCheck
    var i: any = parseInt, r = Math.round, h = from.length > 9, h = typeof (to) == "string" ? to.length > 9 ? true : to == "c" ? !h : false : h, b = p < 0, p: any = b ? p * -1 : p, to: any = to && to != "c" ? to : b ? "#000000" : "#FFFFFF", f = sbcRip(from), t = sbcRip(to);
